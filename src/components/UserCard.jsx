  ...
  return (
    <section className='user'>
        ...
        <div className='user__buttons'>
            <button className='user__delete' onClick={handleDelete} ><ion-icon name="trash-outline"></ion-icon></button>
            <button className='user__edit' onClick={handleEdit}><ion-icon name="create-outline"></ion-icon></button>
        </div>
    </section>
  )
}
